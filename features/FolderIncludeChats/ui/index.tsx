...
import { IncludedChatItem } from "@/widgets/ModalFolderIncludeChats/shared/ui/IncludedChatItem"

interface IFolderIncludeChatsProps {
	localChats: FoundedChatsType[] | undefined
	onChatRemoveOrAdd: (chat: ICutChat) => void
	includeChatIds: string[]
}

export const FolderIncludeChats: FC<IFolderIncludeChatsProps> = ({
	localChats,
	onChatRemoveOrAdd,
	includeChatIds,
}) => {
